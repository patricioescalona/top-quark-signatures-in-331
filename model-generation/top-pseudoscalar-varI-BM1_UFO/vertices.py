...
V_13 = Vertex(name = 'V_13',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_55,(0,1):C.GC_55})
...
V_15 = Vertex(name = 'V_15',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_9,(0,1):C.GC_18})

V_16 = Vertex(name = 'V_16',
              particles = [ P.c__tilde__, P.u, P.AP ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_10,(0,1):C.GC_19})

V_17 = Vertex(name = 'V_17',
              particles = [ P.t__tilde__, P.u, P.AP ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_11,(0,1):C.GC_20})

V_18 = Vertex(name = 'V_18',
              particles = [ P.u__tilde__, P.c, P.AP ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_12,(0,1):C.GC_21})
...
V_20 = Vertex(name = 'V_20',
              particles = [ P.t__tilde__, P.c, P.AP ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_14,(0,1):C.GC_23})

V_21 = Vertex(name = 'V_21',
              particles = [ P.u__tilde__, P.t, P.AP ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_15,(0,1):C.GC_24})

V_22 = Vertex(name = 'V_22',
              particles = [ P.c__tilde__, P.t, P.AP ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
